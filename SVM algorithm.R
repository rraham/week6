...
# the model is performing well on the iris dataset. a lower rate of 26% suggests
# thatt the model is accurately classifying most instances.
#What is the accuracy rate?
# 0.9733333 - an accurate rate of 97.3% is indicating that the model is 
# classifying almost 97.3% of the instances in the iris dataset. this result is
# strong and indicates that the model is effective.

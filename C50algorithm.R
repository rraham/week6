...
#The C5.0 algorithm has correctly classified #approximately 88.889% of the cases 
#in the test data from the Iris dataset. 
#This strong performance suggests that the C5.0 model is effective at 

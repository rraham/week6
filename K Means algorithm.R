...
#the K-Means clustering model has achieved 44.6% level of accuracy in classifying 
#the instances in the Iris dataset.
#TASK: Accuracy = number of correctly classified/(total classified) = ?
#i.e our model has achieved ?% accuracy!
#44.66667 % 
total_classified <- sum(result$size)
correctly_classified <- sum(diag(table(result$cluster, iris.class)))
accuracy <- (correctly_classified / total_classified) * 100
cat("Our model has achieved", accuracy, "% accuracy!")
